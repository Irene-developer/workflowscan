...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql_check_action = "SELECT COUNT(*) AS action_exists FROM imprest_action WHERE username = ? AND imprest_id = ?";
    ...
    $sql_insert_action = "INSERT INTO imprest_action (imprest_id, username, status, comment, signature_path, Position_name) VALUES (?, ?, 'approved', ?, ?, ?)";
    ...
    if ($stmt_insert_action) {
        ...
        if ($stmt_insert_action->execute()) {
            ...
            $sql_update_memo = "UPDATE imprest_expenditure SET status = 'approved' WHERE imprest_id = ?";
            ...
            if ($stmt_update_memo) {
                ...
                if ($stmt_update_memo->execute()) {
                    ...
                    $sql_fetch_approvers = "SELECT Approver1, Approver2, Approver3, username FROM imprest_expenditure WHERE imprest_id = ?";
                        ...
                        if ($current_approver === $approver1) {
                            ...
                            if ($approver2) {
                                ...
                                if ($stmt_fetch_email) {
                                    ...
                                    if ($email) {
                                        $subject = "Action Required: Expenditure Imprest Approval";
                                ...
                                if ($creator_email) {
                                    $subject = "Expenditure Imprest Request Update";
                            ...
                            if ($approver3) {
                                ...
                                if ($creator_email) {
                                    $subject = "Expenditure Imprest Request Completed";
